...
int drawaxes;
double angle;
double radius1,radius2,side,radius3, rotateangle1,rotateangle2;
struct Point
{
    double x,y,z;
    Point(){
...
void drawHand(double radius,Point unitDirectionVector,Point topPoint){
    Point centre  = topPoint+unitDirectionVector*radius ;
...
void display(){
	...
	****************************/
	...
	drawAxes();
	drawHand(radius1,unitDirectionVector1,topPoint1) ;
	drawHand(radius2,unitDirectionVector2,topPoint2) ;
	/*
	glTranslated(0,0,-radius2-side/2) ;
	drawTriangle(side) ;
	glTranslated(-side/2,0,-side+radius3) ;
	glScaled(.2,.2,1) ;
	drawHand(radius3) ;
	glTranslated(2.5*side,0,0) ;
	drawHand(radius3) ;
	glTranslated(2*side,0,0) ;
	drawHand(radius3) ;
	*/
